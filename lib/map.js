  ...
  map.on("load", function () {
        ...
        features: normalizedData.map((city, index) => {
          return {
            ...
            properties: {
              ...
              get biggerRadius() {
                const radius = [this.confirmedRadius, this.deathsRadius];
    ...
    map.addLayer({
      ...
      paint: {
        ...
        "circle-color": "rgba(150, 150, 150, 0.75)",
        "circle-stroke-color": [
          "case",
          [
            "boolean",
